			...
			<div class="card-body">
				...
				<div>
					...
					<div class="form-group">
						...
						<textarea name="about_en" class="about_en" id="about_en"></textarea>
					...
					<div class="form-group">
						...
						<textarea name="shipping_return_en" class="shipping_return_en" id="shipping_return_en"> </textarea>

					</div>
					
					<div class="form-group">
						{!! Form::label('termsofsales', 'Politicas de Privacidade') !!}
						<textarea name="termsofsales" class="termsofsales" id="termsofsales"> </textarea>

					</div>		
					<div class="form-group">
						{!! Form::label('termsofsales_en', 'Politicas de Privacidade EN') !!}
						<textarea name="termsofsales_en" class="termsofsales_en" id="termsofsales_en"> </textarea>
