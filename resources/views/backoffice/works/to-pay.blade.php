                ...
                <div class="row">
                    <div class="col">
                        ...
                        @php
                            $total_value= 0;
                        @endphp
                        @if(!$work->real_invoice_lines($category->id)->isEmpty())
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-right text-nowrap"  scope="col"style="width: 15%">{{ __('Remains To Be Paid') }}</td>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($work->real_invoice_lines($category->id) as $invoiceline)
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-right">{{number_format($invoiceline->line_debt(),2)}}&nbsp;€</td>
                                </tr>
                                @php
                                    $total_value += $invoiceline->line_debt();
                                @endphp
                                @endforeach
                            </tbody>
                            <tfoot>
