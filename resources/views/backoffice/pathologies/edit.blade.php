	...
	<div class="col">
		<div class="card">
			<div class="card-body">
				...
				<form action="{{ route('dashboard.recipes.update', $user->id) }}" method="POST">
					@csrf
					@method('PUT')
					<div class="row">
		...
		<br>
		<a class="btn btn-white" href="{{ route('backoffice.recipes.index') }}"><span class="fa fa-arrow-left"></span>&nbsp; {!! __('recipes') !!}</a>
	</div>
</div>
@endsection
